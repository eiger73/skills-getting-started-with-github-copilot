...
activities = {
    ...
    "Track and Field": {
        "description": "Training for sprints, distance, jumps, and throws; meets on weekends",
    ...
    "Debate Team": {
        "description": "Research and competitive debating on current topics",
        "schedule": "Mondays, 4:00 PM - 5:30 PM",
        "max_participants": 16,
        "participants": ["zach@mergington.edu", "harper@mergington.edu"]
    },
    "Science Club": {
